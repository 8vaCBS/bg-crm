...
module.exports = async function handler(req, res) {
  ...
  try {
    ...
    return res.status(200).json({
      ...
      supTerreno: d.supTerreno || d.supTerrEnO || d.medidaSupTerreno || null,
      supConstruida: d.supConsMt2 || d.supConstruida || d.supConsMt3 || d.medidaSupConst || null,
      rawD: JSON.stringify(d).substring(0, 800),
