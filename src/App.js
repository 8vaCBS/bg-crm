...
const REPORTES_MERCADO = [
  { fuente: 'Portal Inmobiliario', titulo: 'Blog y estadísticas del mercado inmobiliario RM', resumen: 'Análisis de precios de venta y arriendo por comuna, variación trimestral, oferta disponible y tiempo promedio de venta en Santiago.', url: 'https://www.portalinmobiliario.com/h/blog', frecuencia: 'Mensual' },
  { fuente: 'TocToc — INFORENTA', titulo: 'Informe de Mercado de Arriendo en la RM', resumen: 'Stock disponible, ocupación, precio promedio UF/m², caprate y días de exposición. Cubre departamentos, casas y multifamily en el Gran Santiago.', url: 'https://blog.toctoc.com/toctoc-informe-de-mercado-de-arriendo/', frecuencia: 'Trimestral' },
  { fuente: 'Cámara Chilena de la Construcción', titulo: 'Informe MACh — Mercado de Activos y Construcción', resumen: 'Estadísticas oficiales de permisos de edificación, venta de viviendas nuevas y usadas, tasas hipotecarias y proyecciones del sector.', url: 'https://cchc.cl/centro-de-informacion', frecuencia: 'Trimestral' },
  { fuente: 'SII — Servicio de Impuestos Internos', titulo: 'Estadísticas de Bienes Raíces por Comuna', resumen: 'Datos oficiales de avalúos fiscales, número de predios y contribuciones por destino y comuna. Base de datos de impuesto territorial.', url: 'https://www.sii.cl/sobre_el_sii/estadisticas_bienes_raices.html', frecuencia: 'Anual' },
  { fuente: 'Banco Central de Chile', titulo: 'Índice de Precios de Vivienda (IPV)', resumen: 'Evolución trimestral del precio de casas y departamentos en Chile, basado en transacciones reales del SII. Publicación: enero, abril, julio y octubre.', url: 'https://www.bcentral.cl/areas/estadisticas/estadisticas-experimentales/ipv', frecuencia: 'Trimestral' },
];
