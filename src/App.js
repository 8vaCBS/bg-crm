...
const REPORTES_MERCADO = [
  { fuente: 'Tinsa by Accumin — INCOIN', titulo: 'Informe de Coyuntura Inmobiliaria RM', resumen: 'Unidades comercializadas, variación trimestral y anual por comuna. La fuente más citada para ventas de vivienda nueva en el Gran Santiago. Incluye casas y departamentos.', url: 'https://www.tinsa.cl/estudios-e-informes/', frecuencia: 'Trimestral' },
