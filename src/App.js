...
const REPORTES_MERCADO = [
  { fuente: 'Portal Inmobiliario', titulo: 'Informe Trimestral Mercado Residencial Santiago', resumen: 'Precios de venta y arriendo por comuna, variación trimestral, oferta disponible y tiempo promedio de venta.', url: 'https://www.portalinmobiliario.com/novedades/informes', frecuencia: 'Trimestral' },
  { fuente: 'TocToc', titulo: 'Reporte de Precios y Tendencias Inmobiliarias', resumen: 'Análisis de precios UF/m² por sector, evolución de arriendos y ventas en Santiago. Comparativa entre comunas.', url: 'https://www.toctoc.com/blog/estadisticas-mercado-inmobiliario', frecuencia: 'Trimestral' },
  { fuente: 'Cámara Chilena de la Construcción', titulo: 'Informe MACh – Mercado de Activos y Construcción Habitacional', resumen: 'Estadísticas oficiales de permisos de edificación, venta de viviendas nuevas y usadas, tasas hipotecarias.', url: 'https://www.cchc.cl/centro-de-informacion/informes/mach', frecuencia: 'Trimestral' },
  { fuente: 'SII – Servicio de Impuestos Internos', titulo: 'Estadísticas de Bienes Raíces y Transacciones', resumen: 'Datos oficiales de ventas efectivas registradas en el Conservador de Bienes Raíces por comuna y tipo.', url: 'https://www.sii.cl/estadisticas/bienes_raices.htm', frecuencia: 'Anual' },
  { fuente: 'Banco Central de Chile', titulo: 'Índice de Precios de Vivienda (IPV)', resumen: 'Evolución trimestral del precio de las viviendas en Chile. Mide cambios reales en el valor de casas y departamentos.', url: 'https://www.bcentral.cl/web/banco-central/areas/estadisticas/sector-inmobiliario', frecuencia: 'Trimestral' },
];
